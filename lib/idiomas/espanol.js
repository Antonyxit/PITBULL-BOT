...
const smsLista1 = () => { return `🌟 INFORMACIÓN DE 𝑲𝒂𝒕𝒕𝒚 𝑩𝒐𝒕 🌟`}
...
const smsLista7 = () => { return `🐈 INSTALAR 𝑲𝒂𝒕𝒕𝒚 𝑩𝒐𝒕 🐈`}
...
//_allantilink.js
const smsTextoYT = () => { return '𝑲𝒂𝒕𝒕𝒚 𝑩𝒐𝒕 - 𝑾𝒉𝒂𝒕𝒔𝒂𝒑𝒑'} 
...
//_antiviewonce.js
const smsAntiView = () => { return `*Jaja 𝑲𝒂𝒕𝒕𝒚 𝑩𝒐𝒕 Lo Ve Todo*`} 
...
const smsContacto4 = () => { return 'Contacto Oficial de 𝑲𝒂𝒕𝒕𝒚 𝑩𝒐𝒕'}
