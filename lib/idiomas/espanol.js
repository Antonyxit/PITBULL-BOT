...
const smsLista1 = () => { return `🌟 INFORMACIÓN DE 𝑵𝒂𝒕𝒊 𝑭𝒂𝒕𝒊 𝑩𝒐𝒕 🌟`}
...
const smsLista7 = () => { return `🐈 INSTALAR 𝑵𝒂𝒕𝒊 𝑭𝒂𝒕𝒊 𝑩𝒐𝒕 🐈`}
...
//_allantilink.js
const smsTextoYT = () => { return '𝑺𝒕𝒊𝒄𝒉 𝑩𝒐𝒕 - 𝑾𝒉𝒂𝒕𝒔𝒂𝒑𝒑'} 
...
//_antiviewonce.js
const smsAntiView = () => { return `*Jaja 𝑺𝒕𝒊𝒄𝒉 𝑩𝒐𝒕 Lo Ve Todo*`} 
...
const smsContacto4 = () => { return 'Contacto Oficial de 𝑺𝒕𝒊𝒄𝒉 𝑩𝒐𝒕'}
